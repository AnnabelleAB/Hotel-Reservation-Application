...
public class ReservationService {
    ...
    public void addRoom(String roomNumber, double price, String roomType, boolean isFree){
        Room room = new Room (roomNumber,price,roomType,isFree);
        rooms.add(room);
    }
...
return reservationsByCustomer;
    ...
    public Collection<Reservation> getAllReservations(){return reservations;}
    public Collection <IRoom> allRooms(){return rooms;}
